...
/// <summary>
/// Metadata that <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}"/> uses to find out the content
/// root for the web application represented by <c>TEntryPoint</c>.
/// <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}"/> will iterate over all the instances of
...
/// <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}"/> will check for the existence of the marker
...
public sealed class WebApplicationFactoryContentRootAttribute : Attribute
{
    ...
    /// key is used by <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}"/> to determine what of the
