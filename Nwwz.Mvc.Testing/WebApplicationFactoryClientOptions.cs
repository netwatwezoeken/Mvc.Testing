...
using CookieContainerHandler = Nwwz.Mvc.Testing.Handlers.CookieContainerHandler;
using RedirectHandler = Nwwz.Mvc.Testing.Handlers.RedirectHandler;
...
/// <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}.CreateClient(WebApplicationFactoryClientOptions)"/>.
/// </summary>
public class WebApplicationFactoryClientOptions
{
    ...
    /// created by calling <see cref="Nwwz.Mvc.Testing.WebApplicationFactory{TEntryPoint}.CreateClient(WebApplicationFactoryClientOptions)"/>
    /// should follow.
    /// The default is <c>7</c>.
    /// </summary>
    public int MaxAutomaticRedirections { get; set; } = DefaultMaxRedirects;
